...
<template>
    ...
    <div class="transaction-box-container">
        <FiftyText color="dark" variation="body-bold">
        ...
        <div class="inputs">
            ...
            <NewTextInput
                ...
                type="number"
                title="amount"
                @update:modelValue="amountChanged"
            />

            <NewSelectInput
                v-model="transactionDetails.country"
                :disabled="false"
            ...
            <NewTextInput
                :errors="errors.convertedAmount"
                v-model="transactionDetails.convertedAmount"
                :info="currencies_countries[transactionDetails.country] ?? '' "
                :isLoading="isLoadingCurrencyRate"
                label="Receiver gets"
