            ...
            <template #content>
                <form class="  p-2 mb-2" @submit.prevent="submit">
                    <div class="flex flex-wrap gap-2 mb-3 justify-content-center">
                        <TextInput v-model="commissions.from" label="From" placeholder="From" required title="code" />
                        <TextInput v-model="commissions.to" label="To" placeholder="To" required title="code" />
                        <TextInput v-model="commissions.amount" label="Amount" placeholder="Amount" required title="code" />
                    </div>
